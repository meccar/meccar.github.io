...
namespace GCommerce.Migrations
{
    /// <inheritdoc />
    public partial class Created_Phone_With_Brand : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GCommerceBrands", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Is5GSupported = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    BrandId1 = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    ExtraProperties = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ConcurrencyStamp = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GCommercePhones", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GCommercePhones_GCommerceBrands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "GCommerceBrands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GCommercePhones_GCommerceBrands_BrandId1",
                        column: x => x.BrandId1,
                        principalTable: "GCommerceBrands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GCommerceBrands_Name",
                table: "GCommerceBrands",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GCommercePhones_BrandId",
                table: "GCommercePhones",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_GCommercePhones_BrandId1",
                table: "GCommercePhones",
                column: "BrandId1");
        }
